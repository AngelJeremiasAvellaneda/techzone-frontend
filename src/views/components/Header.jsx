...
import useTheme from "@/models/hooks/useTheme";
...
// Navegación principal adaptada para Next.js
const mainNav = [
  { 
    path: ROUTES.HOME, 
    label: "Inicio", 
...
const Header = () => {
  ...
  return (
    <>
      <header 
        className="fixed top-0 w-full z-50 backdrop-blur-2xl bg-white/95 dark:bg-gray-900/95 border-b border-gray-200 dark:border-gray-800 transition-all duration-300"
        style={cssVariables}
      >
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16 relative z-50">
          ...
          {/* Desktop user, notifications, cart, theme */}
          <div className="hidden md:flex items-center space-x-3">
            ...
            {/* Carrito de compras */}
            <Link href={ROUTES.CART} className="relative p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition">
          ...
          <div className="flex items-center space-x-3 md:hidden">
            ...
            {user ? (
              ...
              <Link href={ROUTES.LOGIN} className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition">
