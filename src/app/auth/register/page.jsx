...
import { 
  UserPlus, Mail, Lock, User, Phone, Home, AlertCircle, Eye, EyeOff,
  ArrowLeft
...
const Register = () => {
  ...
  return (
    <BaseLayout>
      <div className="min-h-screen pt-24 flex items-center justify-center py-12 px-4">
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="mt-6">
            ...
            <div className="text-center mt-4">
              <Link href="/terms" className="text-xs text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 mr-2">
                Términos de servicio
              </Link>
              <span className="text-xs text-gray-500 dark:text-gray-400">•</span>
              <Link href="/privacy" className="text-xs text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 ml-2">
          ...
          <div className="text-center">
            <Link href={ROUTES.HOME} className="inline-flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 transition-colors">
